...
import com.zdb.modules.sys.dao.SysUserDao;
...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public List<SysUserEntity> queryListAll() {
		return sysUserDao.queryListAll();
	}
	...
	public boolean hasAdminRole(Long userId) {
		List<Long> list = sysUserDao.queryIsAdminRoleList(userId);
	...
	@Override
	public List<String> queryNameList(Map<String, Object> params) {
		return sysUserDao.queryNameList(params);
	}
}
